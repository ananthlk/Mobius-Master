...
RULES = [
    ...
    ("P3", "tool_manifest", "THE LEADING L2 HYPOTHESIS — MANIFEST SIZE DEGRADES"),
    ...
    ("P1", "integrate", "FIXING THE ROUTING FIRST WOULD HAVE MADE THE SYMPTOM WORSE"),
    ("P2", None, "THE DISQUALIFYING FACT WAS FOUR CHARACTERS TO THE LEFT"),
    ("P1", "integrate", "HOW STEP 2 OF THE FIX MUST ACTUALLY BE WRITTEN"),
    ("P1", "integrate", "CHAT IS IN THE EXACT STATE THAT ALREADY CAUSED A 29-DAY SILENT OUTAGE"),
    ("P1", "integrate", "THE TWO ENDS OF ONE WIRE ARE A MAJOR VERSION APART"),
    ("P1", "integrate", "FOUR SEATS SPENT THE DAY VERIFYING A COMMIT AND NONE OF US VERIFIED THE IMAGE"),
    ("P1", "integrate", "THE PLANNED isError FAIL-CLOSED FIX HAS NO EFFECT"),
    ("P1", "integrate", "THE ROUTING FIX WOULD NOT HAVE FIXED THE SYMPTOM"),
    ("P1", "integrate", "THE LAST LINE OF DEFENCE STRING-MATCHES AN ERROR MESSAGE IT DOES NOT OWN"),
    ("P1", "integrate", "AN HONEST EMPTY ARRIVES DRESSED AS EVIDENCE"),
    ("P1", "integrate", "THREE APPEALS TOOLS ARE DISPATCHED TO A SERVER THAT DOES NOT HAVE THEM"),
...
OUT_OF_PROGRAM = [
    ...
    ("state_load", "ROOT CAUSE OF THE PER-READ OVERHEAD", "decided — declined", "Ananth declined on cost; magnitude under contention unquantified, reopen if that changes"),
