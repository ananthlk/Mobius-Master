...
""", findings=[
 ("bad", "OWNER(chat): THREE APPEALS TOOLS ARE DISPATCHED TO A SERVER THAT DOES NOT HAVE "
          ...
          "therefore UNEXPLAINED; the routing defect and the cited-error symptom are each "
          "confirmed independently. SUPERSEDES MY OWN EARLIER ROOT CAUSE for the CARC 197 "
