...
""", findings=[
 ...
 ("bad", "OUT OF PROGRAM — LIVE MODEL LATENCY DEGRADATION, 2026-09-08/09. Found while "
         ...
         "this than a defect.\n\n"
         "OWNER: not chat and not this program — model routing and the bandit belong to the "
         "LLM Agent, and the cause is upstream Vertex latency. Logged so nobody re-derives it "
         "and so testing done in this window is not misread."),
]),
