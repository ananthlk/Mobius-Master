...
""", findings=[
 ...
 ("bad", "OWNER(chat + appeals seat): THE TWO ENDS OF ONE WIRE ARE A MAJOR VERSION APART ON "
          ...
          "UPPER BOUND (chat requirements.txt:113 `mcp>=1.0.0`; appeals Dockerfile "
          "`mcp[cli]>=1.0,<2` -- note appeals DID bound the major and chat did not, which is why "
          "only chat crossed), so the two ends drifted a major version apart and nothing failed "
