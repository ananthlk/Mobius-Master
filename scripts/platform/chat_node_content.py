...
""", findings=[
 ...
 ("watch", "PROPOSAL, Ananth 2026-09-08 — a config UX over the governor + planner/prompt plane, "
           ...
           "role->reasoning_depth rows, plus the ~10 react env flags. The reasoning_depth map "
           "is what makes the latency claim true — agent_role_to_reasoning_depth() is already "
           "the input to the model bandit's fast/normal/thinking tables, so editing that map IS "
           "changing which model class serves each round.\n\n"
