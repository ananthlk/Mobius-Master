...
""", findings=[
 ...
 ("bad", "OWNER(chat): THE PLANNED isError FAIL-CLOSED FIX HAS NO EFFECT, AND IT WAS THE "
          ...
          "being defaulted -- it is asserting that a failure succeeded. That is the appeals "
 ...
 ("bad", "OWNER(chat): THE LAST LINE OF DEFENCE STRING-MATCHES AN ERROR MESSAGE IT DOES "
          ...
          "is a complete path to success=True with NO BUG ANYWHERE: (1) deployed SDK renames or "
