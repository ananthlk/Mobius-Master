...
""", findings=[
 ...
 ("bad", "OWNER(chat): THREE APPEALS TOOLS ARE DISPATCHED TO A SERVER THAT DOES NOT HAVE "
          ...
          "5 tools ARE hardened at react_loop.py:3073 (unconditional set membership, no "
          "fall-through), so react_loop cannot be the caller -- their candidate is "
          "app/services/tool_agent.py, which has ZERO appeals interception (two prose hits in "
          "prompt strings) and dispatches straight to the registry at :902-915. I verified that "
          "much; it does not by itself explain success=True, since that path also lands on "
          "call_mcp_tool. SUPERSEDES MY OWN EARLIER ROOT CAUSE for the CARC 197 "
