...
ENTRIES += [
    ...
    _entry("d", "health_care_services.general", "General Health Services", ["health care services", "health services", "minimum required services"],
           aliases=["covered services", "MMA services"],
           parent_code="health_care_services"),
    # -- Behavioral / Mental Health --
    _entry("d", "health_care_services.behavioral_health", "Behavioral Health", ["behavioral health", "behavioral health services"],
           aliases=["behavioral healthcare"],
           parent_code="health_care_services"),
    _entry("d", "health_care_services.mental_health", "Mental Health", ["mental health services", "mental health"],
           parent_code="health_care_services"),
    _entry("d", "health_care_services.substance_use_disorders", "Substance Use Disorders", ["substance use disorders", "substance abuse", "sud"],
           parent_code="health_care_services"),
    _entry("d", "health_care_services.emergency_behavioral", "Emergency Behavioral Health", ["emergency behavioral health", "crisis intervention", "baker act"],
           parent_code="health_care_services"),
    # -- Primary / Physician / Nursing --
    _entry("d", "health_care_services.primary_care", "Primary Care", ["primary care", "pcp", "primary care provider"],
           parent_code="health_care_services"),
    _entry("d", "health_care_services.physician", "Physician Services", ["physician services", "physician", "doctor services"],
           aliases=["medical doctor", "md services"],
           parent_code="health_care_services"),
    _entry("d", "health_care_services.physician_assistant", "Physician Assistant Services", ["physician assistant", "pa services"],
           aliases=["PA"],
           parent_code="health_care_services"),
    _entry("d", "health_care_services.arnp", "Advanced Registered Nurse Practitioner", ["advanced registered nurse practitioner", "arnp", "nurse practitioner"],
           aliases=["ARNP services", "advanced practice nurse"],
           parent_code="health_care_services"),
    _entry("d", "health_care_services.nursing", "Nursing Care", ["nursing care", "skilled nursing", "nursing services", "intermittent nursing"],
           aliases=["registered nurse", "rn services"],
           parent_code="health_care_services"),
    # -- Therapy Services --
    ...
    _entry("d", "health_care_services.occupational_therapy", "Occupational Therapy", ["occupational therapy", "ot"],
           parent_code="health_care_services"),
    _entry("d", "health_care_services.speech_therapy", "Speech Therapy", ["speech therapy", "speech-language pathology", "slp"],
           aliases=["speech services"],
           parent_code="health_care_services"),
    _entry("d", "health_care_services.therapy_services", "Therapy Services (General)", ["therapy services", "rehabilitative services", "rehabilitation"],
           parent_code="health_care_services"),
    # -- Dental / Vision / Hearing --
    _entry("d", "health_care_services.dental", "Dental Services", ["dental services", "dental care", "dental", "dentist"],
           aliases=["oral health"],
           parent_code="health_care_services"),
    _entry("d", "health_care_services.vision", "Optometric & Vision Services", ["optometric services", "vision services", "vision care", "eye care", "optometrist"],
           aliases=["optical", "eyeglasses"],
           parent_code="health_care_services"),
    _entry("d", "health_care_services.hearing", "Hearing Services", ["hearing services", "audiology", "hearing care", "hearing aids"],
           parent_code="health_care_services"),
    # -- Specialty Clinical --
    _entry("d", "health_care_services.chiropractic", "Chiropractic Services", ["chiropractic services", "chiropractic", "chiropractor"],
           parent_code="health_care_services"),
    _entry("d", "health_care_services.podiatric", "Podiatric Services", ["podiatric services", "podiatry", "podiatrist", "foot care"],
           parent_code="health_care_services"),
    _entry("d", "health_care_services.renal_dialysis", "Renal Dialysis", ["renal dialysis", "dialysis", "kidney dialysis", "hemodialysis", "peritoneal dialysis"],
           parent_code="health_care_services"),
    # -- Emergency --
    _entry("d", "health_care_services.emergency", "Emergency Services", ["emergency services", "emergency care", "emergency room"],
           aliases=["emergency department", "er", "ed"],
           parent_code="health_care_services"),
    _entry("d", "health_care_services.urgent_care", "Urgent Care", ["urgent care", "walk-in clinic"],
           parent_code="health_care_services"),
    # -- Maternal / Child --
    _entry("d", "health_care_services.family_planning", "Family Planning", ["family planning", "family planning services", "contraception", "contraceptive"],
           parent_code="health_care_services"),
    _entry("d", "health_care_services.child_health", "Child Health Check-Ups", ["child health check-ups", "epsdt", "well-child visits", "well child"],
           aliases=["early periodic screening", "child health screening"],
           parent_code="health_care_services"),
    _entry("d", "health_care_services.immunizations", "Immunizations", ["immunizations", "vaccines", "vaccinations", "immunization schedule"],
           parent_code="health_care_services"),
    _entry("d", "health_care_services.healthy_start", "Healthy Start", ["healthy start", "healthy start services", "prenatal", "postnatal"],
           parent_code="health_care_services"),
    _entry("d", "health_care_services.birth_center", "Birth Center & Midwife", ["birth center", "birthing center", "licensed midwife", "midwifery"],
           parent_code="health_care_services"),
    # -- Facility / Hospital --
    _entry("d", "health_care_services.hospital", "Hospital Services", ["hospital services", "hospital", "inpatient hospital", "hospital care"],
           parent_code="health_care_services"),
    _entry("d", "health_care_services.ambulatory_surgical", "Ambulatory Surgical Center", ["ambulatory surgical center", "asc", "outpatient surgery"],
           parent_code="health_care_services"),
    _entry("d", "health_care_services.clinic", "Clinic Services", ["clinic services", "clinic", "outpatient clinic", "federally qualified health center", "fqhc"],
           parent_code="health_care_services"),
    _entry("d", "health_care_services.lab_imaging", "Laboratory & Imaging", ["laboratory services", "lab", "imaging", "x-ray", "radiology", "mri", "ct scan"],
           aliases=["lab services", "diagnostic imaging"],
           parent_code="health_care_services"),
    # -- Home / Hospice --
    _entry("d", "health_care_services.home_health", "Home Health Services", ["home health services", "home health", "home nursing"],
           aliases=["home care services"],
           parent_code="health_care_services"),
    _entry("d", "health_care_services.hospice", "Hospice Services", ["hospice", "hospice services", "hospice care", "end of life"],
           aliases=["palliative care"],
           parent_code="health_care_services"),
    # -- Transport / Support --
    _entry("d", "health_care_services.transportation", "Transportation Services", ["transportation services", "medical transportation", "non-emergency transportation", "nemt"],
           aliases=["transport", "ambulance"],
           parent_code="health_care_services"),
    _entry("d", "health_care_services.assistive_care", "Assistive Care Services", ["assistive care services", "assistive care", "personal care services"],
           parent_code="health_care_services"),
    # -- Managed Care (general) --
    _entry("d", "health_care_services.managed_care", "Managed Care", ["managed care", "medicaid managed care"],
           parent_code="health_care_services"),
    _entry("d", "health_care_services.appropriate_services", "Appropriate Services", ["appropriate services", "medically appropriate"],
           parent_code="health_care_services"),
    ...
    _entry("d", "benefits.general", "General Benefits", ["benefits", "covered benefits"],
           aliases=["benefit plan", "benefit package"],
           parent_code="benefits"),
    _entry("d", "benefits.dme", "Durable Medical Equipment & Supplies", ["durable medical equipment", "dme", "medical supplies", "prostheses", "orthoses", "medical equipment"],
           aliases=["prosthetics", "orthotics", "assistive devices"],
           parent_code="benefits"),
    _entry("d", "benefits.prescribed_drugs", "Prescribed Drug Services", ["prescribed drug services", "prescribed drugs", "prescription drugs", "prescription medications"],
           aliases=["rx", "drug benefit"],
           parent_code="benefits"),
    ...
    _entry("d", "care_management.general", "General Care Management", ["care management", "care coordination", "case management", "disease management"],
           aliases=["care coordinator"],
           parent_code="care_management"),
    _entry("d", "care_management.adult_day_health", "Adult Day Health Care", ["adult day health care", "adult day care", "adult day health"],
           parent_code="care_management"),
    _entry("d", "care_management.assisted_living", "Assisted Living", ["assisted living", "assisted living facility", "alf"],
           parent_code="care_management"),
    _entry("d", "care_management.attendant_care", "Attendant Care", ["attendant care", "personal care", "personal attendant"],
           parent_code="care_management"),
    _entry("d", "care_management.companion_care", "Adult Companion Care", ["adult companion care", "companion care", "companion services"],
           parent_code="care_management"),
    _entry("d", "care_management.caregiver_training", "Caregiver Training", ["caregiver training", "caregiver education", "family caregiver training"],
           parent_code="care_management"),
    _entry("d", "care_management.behavioral_mgmt", "Behavioral Management", ["behavioral management", "behavior management"],
           parent_code="care_management"),
    _entry("d", "care_management.home_adaptation", "Home Accessibility Adaptation", ["home accessibility adaptation", "home modification", "home accessibility"],
           aliases=["environmental modification"],
           parent_code="care_management"),
    _entry("d", "care_management.home_meals", "Home-Delivered Meals", ["home-delivered meals", "home delivered meals", "meal delivery", "meals on wheels"],
           parent_code="care_management"),
    _entry("d", "care_management.homemaker", "Homemaker Services", ["homemaker services", "homemaker", "home aide", "housekeeping services"],
           parent_code="care_management"),
