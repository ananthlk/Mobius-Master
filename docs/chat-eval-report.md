...
| `tool_manifest` | red | 31 | `test_tool_manifest.py`, `test_tool_manifest_comprehensive.py` | 51 |
...
| `integrate` | amber | 16 | `test_integrate_fallback.py` | 2 |
