...
**80 bugs · 50 sequenced into 5 phases · 30 explicitly outside · 0 unassigned**
...
| **P2** | Instrument — latency and decisions | 13 | chat + Eval | every segment timed; invariants I1-I7 computable from emitted telemetry alone, with no hand-written DB join | P3, P4, P5 | ☐ not started |
...
## P2 — Instrument — latency and decisions  ·  13 items
